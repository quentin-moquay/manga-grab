...
usage += "\t-s {x} or --show-empty-dirs : indicates empty directories or less than {x} pages \n\n"
...
cli.with {
    ...
    s(longOpt: 'show-empty-dirs', args: 1, argName: 'x', 'show empty or less than {x} pages')
